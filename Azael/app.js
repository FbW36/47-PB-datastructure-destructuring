...
const nicePunkBand = {
  name: "Nofx",
  greatest_hit: "Linoleum",
  nationality: "north-american",
  genre: "punk-hardcore",
  myfunction() {
    return `${this.name} is a ${this.nationality} ${this.genre} band, famous because ${this.greatest_hit} song.`;
  },
};

console.log("object :>> ", nicePunkBand.myfunction());
